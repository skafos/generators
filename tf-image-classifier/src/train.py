...
FLAGS = AttrDict()
FLAGS["data_path"] = "data/"#os.environ["data_path"]
FLAGS["artifacts_path"] = "artifacts/"#os.environ["artifacts_path"]
FLAGS["model_name"] = "ImageClassifier"
...
FLAGS["tfhub_module"] = "https://tfhub.dev/google/imagenet/resnet_v2_50/feature_vector/3"
FLAGS["logging_verbosity"] = 'WARN'
