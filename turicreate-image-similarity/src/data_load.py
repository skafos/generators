...
data_sources = {
    "zappos": "https://s3.amazonaws.com/skafos.example.data/ImageSimilarity/ZapposBoots.tar.gz"
}
...
if __name__ == "__main__":
    print("\n##### Loading Image Similarity Sample Data #####", flush=True)
    ...
    if not data_url:
        sys.exit("Non-supported data source - {}".format(data_src))
